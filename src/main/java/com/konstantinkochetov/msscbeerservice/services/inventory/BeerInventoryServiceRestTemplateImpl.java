...
@Profile("!local-discovery") // not local discovery
@Slf4j
...
public class BeerInventoryServiceRestTemplateImpl implements BeerInventoryService {
    ...
    // binds to application.properties "sfg.brewery.beer-inventory-service-host" vie prefix above
    ...
    public Integer getOnhandInventory(UUID beerId) {
        ...
        ResponseEntity<List<BeerInventoryDto>> responseEntity = restTemplate
                .exchange(beerInventoryServiceHost + INVENTORY_PATH, HttpMethod.GET, null,
                        new ParameterizedTypeReference<List<BeerInventoryDto>>(){}, (Object) beerId); // binds url to beerId (from INVENTORY_PATH)
